...
class BikeSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        url = ["https://www.bike-discount.de/en/bike", "https://www.bike-discount.de/en/bike/training-leisure-time/", "https://www.bike-discount.de/en/bike-electronics"]
        for url_i in url:
            yield(scrapy.Request(url_i, callback=self.parse_site, meta=dict(
                        playwright = True,
